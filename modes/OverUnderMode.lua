-- Over/Under: players type "over" or "under" to bet on the host's 1-100 roll landing above or
-- below 50. Even money against the host (the house). A roll of exactly 50 wins every bet for the
-- house. Round state lives in game.overunder = { picks = { name = "over"|"under" }, resolved }.
