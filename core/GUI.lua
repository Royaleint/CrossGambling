...
summaryText:SetPoint("TOPLEFT", 20, -30)
summaryText:SetPoint("TOPRIGHT", -20, -30)
...
searchBox:SetPoint("TOPLEFT", 20, -54)
...
-- We joined someone else's game: lock the host-only controls. "New Game" stays enabled so a
-- player can always start hosting, even if the host vanished mid-game.
